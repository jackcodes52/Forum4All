...
import com.example.forum4all_1.adapters.MusicPostAdapter;
...
public class MusicActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    MusicPostAdapter postAdapter;
    FirebaseDatabase firebaseDatabase;
    DatabaseReference databaseReference;
    List<MusicPost> postList;
    ...
    private void checkAndRequestForPermission(){
        ...
        if (ContextCompat.checkSelfPermission(MusicActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
            if(ActivityCompat.shouldShowRequestPermissionRationale(MusicActivity.this,Manifest.permission.READ_EXTERNAL_STORAGE)){
                Toast.makeText(MusicActivity.this,"Permission to access media.",Toast.LENGTH_SHORT).show();
            }else{
                ActivityCompat.requestPermissions(MusicActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},PReqCode);
            }
        }else
            openGallery();
    }
    ...
    private void iniPopup() {
        ...
        popAddPost.setContentView(R.layout.layout_addpost_music);
        ...
        popupPostImage = popAddPost.findViewById(R.id.musicinsertimg);
        popupTitle = popAddPost.findViewById(R.id.musicTitle);
        popupDesc = popAddPost.findViewById(R.id.musicdesc);
        popupAddbtn = popAddPost.findViewById(R.id.musicmakepost);
    ...
    public void onClick(View view) {
        switch(view.getId()){
            case R.id.reportforumbtn:
                startActivity(new Intent(this, MusicReport.class));
                break;
            case R.id.makepostbtn:
                popAddPost.show();
                break;
            case R.id.musicmakepost:
                popupClickProgress.setVisibility(View.VISIBLE);
                if (!popupTitle.getText().toString().isEmpty() && !popupDesc.getText().toString().isEmpty() && pickedImgUri != null){

                    StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("Music Images");
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    //Create Post Object
                                    MusicPost post = new MusicPost(popupTitle.getText().toString(),
    ...
    private void addPost(MusicPost post) {

        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference myRef = database.getReference("Music Posts").push();
    ...
    private void showMessage(String message) {
        ...
        Toast.makeText(MusicActivity.this,message,Toast.LENGTH_SHORT).show();
    }
    ...
    public void onStart() {
        ...
        super.onStart();
        listrecyclerView = findViewById(R.id.musicpostlist);
        listrecyclerView.setLayoutManager(new LinearLayoutManager(getApplication()));
        listrecyclerView.setHasFixedSize(true);
        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("Music Posts");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot postsnap : snapshot.getChildren()) {
                    ...
                    MusicPost post = postsnap.getValue(MusicPost.class);
                    postList.add(post);

                }

                postAdapter = new MusicPostAdapter(getApplication(), postList);
